...
public class levels {
    ...
    public static int[][] sleutels(int index){
        int[][][] sleutels = {
                ...
                {
                        {1,5,100},{5,2,200},{9,7,100},{9,6,200},{9,5,300}
                }
        };
    ...
    public static int[][] barricades(int index){
        int[][][] barricades = {
                ...
                {{2, 2, 200}},
                {{4,8,100},{4,3,100},{6,0,200},{6,3,300},{7,6,200},{6,8,100}}
        };
    ...
    public static int[][] muren(int index){
        int[][][] muren = {
                ...
                {{3, 3}},
                {{1,0},{1,1},{1,2},{1,3},{1,4},{1,6},{1,7},{1,8},{2,8},{3,5},{3,8},{5,9},{5,8},{5,7},{5,6},{5,5},{5,4},{5,3},{6,2},{5,1},{3,6},{3,5},{3,3},{3,2},{3,1},{4,1},{2,5},{7,0},{8,0},{9,0},{9,8},{8,8},{7,8},{7,8},{8,2},{8,3},{8,4},{8,5},{8,6},{8,7},{7,4},{6,6}}
        };
        return muren[index];
    }
